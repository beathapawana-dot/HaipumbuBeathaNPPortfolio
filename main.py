...
# --- THEME DESIGN SYSTEM (Aurora Emerald Forest) ---
BG = '#0B130E'
SURFACE = '#14221A'
TEXT = '#F2FFF6'
MUTED = '#8FA396'
...
def main(page: ft.Page):
    page.title = "Haipumbu Beatha NP - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Haipumbu Beatha NP", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ft.Icon(ft.Icons.WORK_OUTLINE, size=15, color=MUTED),
                        ft.Text("Role: Backend/Firebase (Mechanical Department)", color=MUTED, size=14),
                        ft.Container(width=10),
                        ft.Icon(ft.Icons.EMAIL_OUTLINED, size=15, color=MUTED),
                        ft.Text("beathahaipumbu1@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/beathapawana-dot", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/screens/EstimateSummaryScreen.js', 'src/services/estimateService.js', 'src/utils/calculations.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Estimation formulas and save workflow.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Haipumbu Beatha NP"\ngit config user.email "beathahaipumbu1@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
            ...
            ft.Container(
                ...
                content=tile_card("Academic Project Reflection (Blog)", [
                    ...
                    ft.Text("During the semester, my primary focus was on establishing a secure, scalable, and highly performant backend architecture for the SiteSpy construction estimation platform. I engineered the Firestore database schema and implemented security rules to restrict data access on a per-user/per-project basis. Ensuring estimation reliability meant implementing server-side validators and atomic write batches to maintain data consistency.", size=14, color=TEXT),
                    ft.Divider(color=BORDER),
                    ft.Text("Lessons Learned:", size=12, color=MUTED, weight=ft.FontWeight.BOLD),
                    ft.Text("This project was an excellent opportunity to learn Flet's GUI architecture and Firebase integration in a collaborative setting. I deepened my knowledge of transactional data operations, environment configuration best practices, and automated testing. Developing under strict git constraints taught me the value of well-documented commits and clean code segregation.", size=14, color=TEXT)
                ])
            ),
            ...
            ft.Container(
                ...
                content=tile_card("Challenges & Resolutions", [
                    ...
                    ft.Text("One of the major challenges was handling asynchronous database read/write bottlenecks over poor site connectivity. I addressed this by implementing offline cache configurations in Firestore, structured optimistic UI loads in Flet, and minimizing data payloads to keep operations fast and reliable.", size=14, color=TEXT)
                ], ACCENT_2)
            ),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Haipumbu Beatha NP | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
